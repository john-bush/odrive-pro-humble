...
#include "ros2_odrive_can/srv/set_input_torque.hpp"
...
private:
    ...
    rclcpp::Service<ros2_odrive_can::srv::SetInputCurrent>::SharedPtr service_set_input_torque_;
    ...
    void set_input_torque_callback(const std::shared_ptr<ros2_odrive_can::srv::SetInputCurrent::Request> request, std::shared_ptr<ros2_odrive_can::srv::SetInputCurrent::Response> response);
