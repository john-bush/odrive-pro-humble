                                     ...
                                     socket_generic_write_(0x00)
{
    ...
    service_set_input_torque_ = this->create_service<ros2_odrive_can::srv::SetInputCurrent>("odrive/set_input_torque", std::bind(&CanService::set_input_torque_callback, this, std::placeholders::_1, std::placeholders::_2));
...
void CanService::set_input_torque_callback(const std::shared_ptr<ros2_odrive_can::srv::SetInputCurrent::Request> request, std::shared_ptr<ros2_odrive_can::srv::SetInputCurrent::Response> response)
{
    can_frame send_frame;
